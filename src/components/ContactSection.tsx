        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2 space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-display font-medium text-lg mb-1">Email</h3>
                <a href="mailto:hello@swetah.com" className="text-muted-foreground hover:text-primary transition-colors">
                  hello@swetah.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-display font-medium text-lg mb-1">Phone</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-display font-medium text-lg mb-1">Location</h3>
            ...
            <div className="pt-4">
              <h3 className="font-display font-medium text-lg mb-4">Connect with me</h3>
